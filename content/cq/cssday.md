...
- img: cqs/thinker-browsers.jpg
  ...
  caption: Photo by [Avery Evans](https://unsplash.com/@averye457?utm_source=unsplash&utm_medium=referral&utm_content=creditCopyText) on Unsplash
- img: cqs/cssday/tab.jpg
  fit: contain
  alt: >
    Tab Atkins on stage at CSS Day
    in a previous year
- img: cqs/cssday/tab-no.jpg
  fit: contain
  alt: >
    Tab Atkins
    with a scribbled red speech bubble:
    no!
- quote: >
...
- video: https://player.vimeo.com/video/509392626#t=1m5s
...
- img: cqs/cssday/una.jpg
  alt: >
    Una Kravets on stage at CSS Day,
    with a slide that shows
    combining container queries with the has selector
...
- img: cqs/cssday/heydon.jpg
  alt: |
    Heydon behind the podium at CSS Day,
...
- img: cqs/cssday/una-state.jpg
  alt: >
    Una Kravets on stage at CSS Day,
    with a slide that shows
    The stuck state query in Chrome Canary
  caption: Photo by [Manuel Matuzović](https://front-end.social/@matuzo/110507494543628315)
