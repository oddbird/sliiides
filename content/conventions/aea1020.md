...
- img: conventions/systems-cssedit.jpg
  alt: |
    CSS Edit using CSS comments in a single file
    to generate nested folders in the sidebar navigation
  fit: contain
...
- pre: Still just
  title: A CSS **Pre-Processor**
  sub: Without *selectors*
